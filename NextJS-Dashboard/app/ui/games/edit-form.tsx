...
import { editGame } from '@/app/lib/game-actions';
...
export default function EditGameForm({
  ...
  const editgamewithId = editGame.bind(null,game.id);
  const [state,dispatch]= useFormState(editgamewithId,initialState);
  return (
