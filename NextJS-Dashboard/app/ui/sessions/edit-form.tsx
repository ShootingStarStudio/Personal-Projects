...
import { Participant, Session } from '../../lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
...
import { editSession } from '../../lib/session-actions';
...
export default function EditSessionForm({
  ...
  const editSessionWithId = editSession.bind(null, session.id);
  const [state, dispatch] = useFormState(editSessionWithId, initialState);
